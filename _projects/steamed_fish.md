...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/steamed_fish_title.jpg" title="清蒸鱼" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/steaming_rack.jpg" title="Steaming Rack" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Steaming rack with chopsticks
</div>
